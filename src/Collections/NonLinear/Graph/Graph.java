...
public abstract class Graph<T> implements GraphADT<T> {
    ...
    protected T getVertice(int index) {
    ...
    protected abstract Iterator<T> iteratorBFS(int startIndex);
    ...
    protected abstract Iterator<T> iteratorDFS(int startIndex);
    ...
    protected abstract Iterator<T> iteratorShortestPath(int index1, int index2) throws EmptyCollectionException;
